...
def main() -> None:
    ...
    parser.add_argument("--pilot-manifest", type=Path, default=ROOT / "work/pferi_v2/gpu/measurement_feasibility/restricted_pilot_manifest.csv")
    parser.add_argument("--pilot-audit", type=Path, default=ROOT / "work/pferi_v2/gpu/measurement_feasibility/restricted_pilot_manifest_audit.json")
    ...
    parser.add_argument("--execution-manifest", type=Path, default=ROOT / "work/pferi_v2/pipeline/descriptor_manifests/restricted_descriptor_execution_manifest.csv")
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "archive/pferi_v2/task_runs/dual_sample_confirmation/2026-07-15_timed_operational_rehearsal_v2")
