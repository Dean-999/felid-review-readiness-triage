#!/usr/bin/env python3
"""Audit CzechLynx second-review CSV for blinding compliance."""
...
REVIEW_IMAGE_DIR = "data/interim/czechlynx/second_review_images/"
REVIEW_FILENAME_PATTERN = re.compile(r"^czlx_second_\d{4}\.jpg$")
...
def main() -> int:
    ...
    if missing_images:
        ...
        passes.append("All referenced second-review images exist.")
    ...
    if bad_filenames:
        ...
        passes.append("All review image filenames match czlx_second_####.jpg.")

    print("CzechLynx second-review blinding audit")
