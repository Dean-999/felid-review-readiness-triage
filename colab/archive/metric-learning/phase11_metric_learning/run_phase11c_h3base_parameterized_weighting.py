#!/usr/bin/env python3
"""Dry-run runner for Phase 11C-2 H3-base parameterized weighting commands."""
...
CONFIGS = [
    "config_phase11c_h3base_a00_g050.yaml",
    "config_phase11c_h3base_a05_g050.yaml",
    "config_phase11c_h3base_a05_g065.yaml",
    "config_phase11c_h3base_a10_g065.yaml",
    "config_phase11c_h3base_a05_g080.yaml",
]
...
def planned_record(root: Path, config_name: str, split_id: int) -> dict[str, object]:
    ...
    return {
        ...
        "positive_weight_alpha": float(config["loss"]["positive_weight_alpha"]),
        "positive_weight_gamma": float(config["loss"]["positive_weight_gamma"]),
...
def main() -> None:
    ...
    print("Phase 11C-2 H3-base parameterized positive-weighting planned runs:")
    ...
    for split_id in args.splits:
        for config_name in CONFIGS:
            ...
            print(
                ...
                f"alpha={record['positive_weight_alpha']} "
                f"gamma={record['positive_weight_gamma']} "
    ...
    record_path = root / "phase11c_h3base_parameterized_weighting_run_records.json"
