...
> **Superseded as an active protocol on 2026-07-10.** This historical plan is retained to document the prior 800–1,200-pair ambition, but it does not meet the PF-ERI v2 measurement, deduplication, feature-independence, representative-queue, and development/calibration/confirmation requirements. Use `PROJECT_RULES.md` and the v2 documents in `paper/protocols/` for all current work.
