...
The output is `work/pferi_v2/pipeline/descriptor_manifests/czechlynx_v2_image_context.csv`, with an audit at `work/pferi_v2/pipeline/descriptor_manifests/czechlynx_v2_image_context_audit.json`. It establishes image availability for a future v2 descriptor queue only. It is not a pair set, feature table, review packet, or outcome dataset.
