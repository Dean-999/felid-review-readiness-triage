# legacy-code17a CzechLynx Review-Utility Validation Plan
...
Reason rejected: legacy-code16h already showed no conservative descriptor-only top-k
improvement claim. Forcing that endpoint would create a claim vulnerability.

## Tasks

1. Build `scripts/build_legacy-code17a_czechlynx_review_utility.py`.
2. Use legacy-code16h scored CzechLynx pairs as input.
...
8. Update docs to point to legacy-code17a.
...
python scripts/build_legacy-code17a_czechlynx_review_utility.py
```
