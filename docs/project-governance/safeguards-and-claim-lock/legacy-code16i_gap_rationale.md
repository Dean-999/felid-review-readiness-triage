# legacy-code16i PF-ERI Gap Rationale
...
## Internal Evidence From legacy-code16

legacy-code16g created the first real CzechLynx pair-level bridge:
...
legacy-code16h readiness controls passed the design gate:
...
legacy-code16h calibrated-router validation found signal but not a ranking-improvement
claim:
...
| "Background/source leakage could inflate results." | Serious. | Use leakage-excluded grouped splits as default and report leakage sensitivity. This is already implemented in legacy-code16h. |
...
1. Freeze the claim boundary in every legacy-code16/legacy-code17 document.
2. Convert legacy-code16h from a ranking-improvement attempt into a review-utility
   validation stage.
...
The next phase should be legacy-code16i/legacy-code17a review-utility validation, not another
